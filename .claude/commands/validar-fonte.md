...
- A.Pet: lista de cobertura, carência e exclusões. As exclusões devem bater com `exclusoes_apet` e com a cláusula correspondente das condições gerais. Conferir o recorte do tártaro: a limpeza de tártaro (tartarectomia) é coberta como assistência, com carência de 180 dias e sem exames nem anestesia, e os demais tratamentos odontológicos são excluídos. O material não pode prometer cobertura odontológica ampla no A.Pet.
- Limite anual da Petlove de 200 vezes o valor mensal do plano, conforme as condições gerais.
- Reajuste técnico da Petlove: aplicado apenas se o custo médico ultrapassar 50% da receita correspondente, conforme as condições gerais.
...
- Verificações confirmadas, conforme a referência oficial do `CLAUDE.md`: início da carência da Petlove (1º pagamento, com atualização da condição geral até o fim de julho de 2026), pulo de carência (condição geral item 6 e FAQ Itaú Personnalité), tartarectomia no A.Pet (assistência; disponibilidade por certificado, item 3.2.4), serviços de conveniência (A.Pet e Ecossistema Petlove) e pré-existência da Petlove (não especificada nas condições gerais). Conferir se cada uma aparece com a fonte e sem promessa indevida. Único ponto ainda em alinhamento, com selo: disponibilidade por canal por segmento. No pulo de carência, conferir que não há promessa de liberação integral nem automática.
